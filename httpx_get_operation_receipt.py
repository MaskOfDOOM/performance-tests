...
#Открытие кредитного счёта/карты
...
make_purchase_operation_payload = {
  ...
  "accountId": open_credit_card_account_response_data['account']['cards'][0]['accountId'],
  "category": "taxi"
}
